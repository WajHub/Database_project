...
UPDATE Hala SET Pojemnosc_kibicow = 6000;

-- Druzyna zmienia nazwe ze wzgledu na nowego sponsora
UPDATE Druzyna SET Nazwa = 'zmienionaNazwa' WHERE Nazwa = 'PingPongTeam1';
